...
int main(){
   ...
   do {
    ...
    if (postava == "lovec") {
        ...
        string schopnost1="Lovecky_Drap";
        string schopnost2="Asasinska_Cepel";
        string schopnost3="Hodina_Lovu";
    ...
    switch (odpoved_dom) {
        ...
        case 1:
            ...
            Sleep(3500);
            cout << endl << "*Najednou uvidis nejakou truhlici, je to velka truhlice a vypada ze v ni bude neco velkeho*";
            Sleep(3500);
        ...
        case 2:
            ...
            Sleep(2500);
            cout << endl << "*Je to lektvar zivota, ten ti zvedne zivoty o jeden bod*";
            Sleep(3000);
