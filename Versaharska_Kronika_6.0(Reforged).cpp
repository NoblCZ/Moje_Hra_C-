...
void vesnice() {
    ...
    cout << "           ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~            " << endl;
    cout << "          ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~           " << endl;
    cout << "                (Malá vesnièka ukrytá v poli a vetríku)           " << endl;
}
void obrazekLektvar() {
    cout << "        ______" << endl;
    cout << "       /      \\" << endl;
...
void Battle(int &zdraviL, int &manaL, int obranaL, int utokL, int zdravi_nepritelL, int utok_nepritelL, int obrana_nepritelL, string nepritel_jmenoL, string jmenoL, int levelL, string schopnost1L, string schopnost2L, string schopnost3L, int schopnostL[3]) {
    ...
    Sleep(1000);
    cout << "Prisel jsi o: " << damageP << " zivot/u";
...
cara();
        ...
        cout << endl << "Mana: " << mana;
        Sleep(3000);
        cout << endl << endl << "*Nyni musis jit zpet do vesnice Urth a rict o tom lidem!*";
        Sleep(7500);
        ...
        Sleep(3500);
        cout << endl << "*Po chvili vchazis do vesnice a jdes hned za muzem, ktery te predtim na chvili ubytoval*";
        Sleep(3500);
        ...
        Sleep(3500);
        cout << endl << "Pani, pane vy jste to dokazal, neverim vlastnim ocim";
        Sleep(3250);
        reputace += 1;
        cout << endl << endl << "Reputace byla zvysena o jeden bod / Reputace: " << reputace;
        Sleep(3250);
        ...
        Sleep(3500);
        cout << endl << "Pokud dovolite pane rad bych se vam prestavil, me jmeno je Rames, jak jste jiz slysel, jsem radnim tohoto mesta";
        Sleep(4000);
        cout << endl << "Pokud dovolite pane, rad bych vam zaridil audienci s kralovskym radcem teto provincie";
        Sleep(3500);
        cout << endl << "Hmm, to je velmi skvela nabidka, jak odpovis?: 1 - Ano pane, bude mi velkou cti / 2 - Ne, nemam zajem";
        cin >> odpoved_radni;
        Sleep(2000);
        ...
        if (odpoved_radni == 1) {
            ...
            Sleep(3500);
            cout << endl << "Ale, kdyby nahodou, techto 150 zlataku navic vas urcite presvedci";
            Sleep(3500);
